...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.sub_payment_lines TO authenticated;
GRANT ALL ON public.sub_payment_lines TO service_role;
...
GRANT ALL ON public.salary_employees TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.salary_roster_meta TO authenticated;
GRANT ALL ON public.salary_roster_meta TO service_role;
