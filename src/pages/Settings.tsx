...
import { ArrowLeft, Palette, FormInput, Store, Bell, HardDrive, Download, Banknote, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-lg space-y-4 px-4 py-6">
        ...
        >
          ...
          <div className="min-w-0">
            <h2 className="text-sm font-semibold text-foreground">Nhân viên</h2>
            <p className="text-xs leading-relaxed text-muted-foreground">
              Tên và lương từng người, hoặc dán JSON từ app lương để map vào Lương NV.
            </p>
          </div>
        </Link>
