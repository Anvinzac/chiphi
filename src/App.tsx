...
import { signInAsDemo } from "@/hooks/useDemoAuth";
...
function AutoDemoRoute({ children }: { children: React.ReactNode }) {
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/" element={<AutoDemoRoute><Index /></AutoDemoRoute>} />
